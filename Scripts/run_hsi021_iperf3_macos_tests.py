...
def main():
    ...
    macos_commands = [
        # US_Classic_Only
        f"python3 ../lld_test.py -iperf3-darwin --clientIP {client_ip} --scenario US_Classic_Only -test-group-name HSI021",
        
        # DS_Classic_Only
        f"python3 ../lld_test.py -iperf3-darwin --clientIP {client_ip} --scenario DS_Classic_Only -test-group-name HSI021",
        
        # US_Combined
        f"python3 ../lld_test.py -iperf3-darwin --clientIP {client_ip} --scenario US_Combined -test-group-name HSI021",
        
        # DS_Combined
        f"python3 ../lld_test.py -iperf3-darwin --clientIP {client_ip} --scenario DS_Combined -test-group-name HSI021",
        
        # US_LL_Only
        f"python3 ../lld_test.py -iperf3-darwin --clientIP {client_ip} --scenario US_LL_Only -test-group-name HSI021",
        
        # DS_LL_Only
        f"python3 ../lld_test.py -iperf3-darwin --clientIP {client_ip} --scenario DS_LL_Only -test-group-name HSI021"
    ]
    
    print("=" * 80)
    print("HSI021 macOS iPerf3 TEST SUITE")
    ...
    print("=" * 80)
    print("HSI021 macOS iPerf3 TEST SUITE COMPLETE")
