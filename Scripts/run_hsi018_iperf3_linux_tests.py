...
def main():
    ...
    client_ip = "96.37.176.25"
    
    # Baseline tests - RTT_0 only (no PacketStorm latency injection)
    baseline_commands = [
        # US_Classic_Only - RTT_0
        f"python3 ../lld_test.py -iperf3 --clientIP {client_ip} --scenario US_Classic_Only -test-group-name HSI018",
        
        # DS_Classic_Only
        f"python3 ../lld_test.py -iperf3 --clientIP {client_ip} --scenario DS_Classic_Only -test-group-name HSI018",
        
        # US_Combined
        f"python3 ../lld_test.py -iperf3 --clientIP {client_ip} --scenario US_Combined -test-group-name HSI018",
        
        # DS_Combined
        f"python3 ../lld_test.py -iperf3 --clientIP {client_ip} --scenario DS_Combined -test-group-name HSI018",
        
        # US_LL_Only
        f"python3 ../lld_test.py -iperf3 --clientIP {client_ip} --scenario US_LL_Only -test-group-name HSI018",
        
        # DS_LL_Only
        f"python3 ../lld_test.py -iperf3 --clientIP {client_ip} --scenario DS_LL_Only -test-group-name HSI018"
    ]
    
    print("=" * 80)
    print("HSI018 iPerf3 BASELINE TEST SUITE")
    ...
    print("=" * 80)
    print("HSI018 iPerf3 BASELINE TEST SUITE COMPLETE")
